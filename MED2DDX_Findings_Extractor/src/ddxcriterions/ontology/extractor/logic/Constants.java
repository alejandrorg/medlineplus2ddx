...
public class Constants {
	...
	public final static String BIOPORTAL_QUERY_SUBCLASSES_FILE = "sparql/query_bioportal_subclasses.sparql";
	public final static String BIOPORTAL_QUERY_SUBCLASSES_COUNT_FILE = "sparql/query_bioportal_count_subclasses.sparql";
	public final static String BIOPORTAL_QUERY_SYMPTOMS_ONTOLOGY_FILE = "sparql/query_bioportal_symptoms_ontology.sparql";
	public final static String BIOPORTAL_QUERY_TM_SIGNS_AND_SYMPTOMS_ONTOLOGY_FILE = "sparql/query_bioportal_tm-signs-and-symptoms_ontology.sparql";
	public final static String OLD_QUERY_FILE = "sparql/query_OLD.sparql";
