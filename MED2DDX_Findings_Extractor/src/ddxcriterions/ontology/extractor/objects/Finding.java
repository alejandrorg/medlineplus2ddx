package ddxcriterions.ontology.extractor.objects;

import java.util.LinkedList;

import ddxcriterions.ontology.extractor.logic.Constants;
...
public class Finding {
	...
	public Finding(String n, String c, String u, String cui, String s) {
		this.cuis = new LinkedList<String>();
		this.synonyms = new LinkedList<String>();
		this.codes = new LinkedList<String>();
		this.name = n;
	...
	public String toWrite() {
		...
		return name + Constants.CHAR_SEPARATOR + code + Constants.CHAR_SEPARATOR + cuis + Constants.CHAR_SEPARATOR + uri + Constants.CHAR_SEPARATOR + synoms + Constants.CHAR_SEPARATOR
				+ altCodes + Constants.CHAR_SEPARATOR + source;
	}
