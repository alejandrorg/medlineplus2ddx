...
public class Disease {
	...
	public void storeAsText() throws Exception {
		...
		prop.store(
				new FileOutputStream("data/diseases/" + name + ".dis", false),
				"");
	}
	...
	public void saveMedicalConcepts() throws Exception {
		System.out.print("Saving results of disease '" + this.getName()
				+ "' .. ");
		BufferedWriter bW = new BufferedWriter(new FileWriter("diseases/"
				+ this.getName() + ".dis"));
