...
public class FindingsManager {
	 ...
	 */
	public static void write(LinkedList<ValidationFinding> findings, String f)
			throws Exception {
	...
	public static void mergeAll(String folder, String file) throws Exception {
		...
		LinkedList<ValidationFinding> fds = readAllFindingsFiles(folder);
	 ...
	 * @throws Exception Puede lanzar excepción.
	 */
	private static LinkedList<ValidationFinding> readAllFindingsFiles(String folder)
			throws Exception {
		LinkedList<ValidationFinding> findings = new LinkedList<ValidationFinding>();
	 ...
	 * @throws Exception Puede lanzar excepción.
	 */
	public static LinkedList<ValidationFinding> loadAllFindings(String f) throws Exception {
		LinkedList<ValidationFinding> findings = new LinkedList<ValidationFinding>();
		int readed = 0;
